                ...
                TextButton(
                  ...
                  onPressed:  () {
                    if(_textFieldController.text.isNotEmpty)
                      {
                        context.read(patientProvider).update_height(widget.id,double.parse(_textFieldController.text) );
                        context.read(patientProvider).add_height(double.parse(_textFieldController.text));
              ...
              builder: (context,watch,child){
                ...
                return patientinfo.when(
                  data: (data){
                    return Row(
                        children:[
                          data.docs.first.get("Height")==0.0?
                          Text("- -",style: TextStyle(color: Colors.white),)
                              :Text(data.docs.first.get("Height").toString(),style: TextStyle(color: Colors.white),),
